  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${pageContext.request.contextPath}/user/querylist">
     ...
     <tr>
            ...
            <td>
					 <c:choose>
					      <c:when test="${user.statusId==1}">${str1 }</c:when>
					      <c:otherwise><font><a style="color:red">${str2 }</a></font></c:otherwise>
					 </c:choose>
