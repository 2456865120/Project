...
function initChat3(data){
	...
	for(var i=0;i<data.length;i++){
    	...
    	if(data[i].name=='安徽'){
    		var y13=data[i].value;
    	}
    	if(data[i].name=='福建'){
    		var y14=data[i].value;
    	}
		if(data[i].name=='江西'){
			var y15=data[i].value;
		}
		if(data[i].name=='山东'){
			var y16=data[i].value;
		}
		if(data[i].name=='河南'){
			var y17=data[i].value;
		}
		if(data[i].name=='湖南'){
			var y19=data[i].value;
		}
		if(data[i].name=='湖北'){
			var y18=data[i].value;
		}
		if(data[i].name=='广东'){
			var y20=data[i].value;
		}
		if(data[i].name=='海南'){
			var y21=data[i].value;
		}
		if(data[i].name=='四川'){
			var y22=data[i].value;
		}
		if(data[i].name=='贵州'){
			var y23=data[i].value;
		}
		if(data[i].name=='云南'){
			var y24=data[i].value;
		}
		if(data[i].name=='陕西'){
			var y25=data[i].value;
		}
		if(data[i].name=='甘肃'){
			var y26=data[i].value;
		}
		if(data[i].name=='青海'){
			var y27=data[i].value;
		}
		if(data[i].name=='台湾'){
			var y28=data[i].value;
		}
		if(data[i].name=='内蒙古'){
			var y29=data[i].value;
		}
		if(data[i].name=='广西'){
			var y30=data[i].value;
		}
		if(data[i].name=='西藏'){
			var y31=data[i].value;
		}
		if(data[i].name=='宁夏'){
			var y32=data[i].value;
		}
		if(data[i].name=='新疆'){
			var y33=data[i].value;
		}
		if(data[i].name=='香港'){
			var y34=data[i].value;
		}
		if(data[i].name=='澳门'){
			var y35=data[i].value;
		}
     };
