    ...
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${contract.id}" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
               <select id="trainContract_id" name="trainContractid" class="valid">
                  			<c:forEach items="${requestScope.traincontract_list}" var="job">
						   		<c:choose>
			    					<c:when test="${contract.trainContractid == job.id }">
			    						<option value="${job.id }" selected="selected">${job.name }</option>
			    					</c:when>
			    					<c:otherwise>
			    						<option value="${job.id }">${job.name}</option>
           ...
           <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
               <select id="laborContract_id" name="laborContractid" class="valid">
                             <c:forEach items="${requestScope.laborcontract_list}" var="job">
						   		<c:choose>
			    					<c:when test="${contract.laborContractid == job.id }">
			    						<option value="${job.id }" selected="selected">${job.name }</option>
			    					</c:when>
			    					<c:otherwise>
			    						<option value="${job.id }">${job.name}</option>
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
               <select id="confidentialityContract_id" name="confidentialityContractid" class="valid">
                             <c:forEach items="${requestScope.confidentialitycontract_list}" var="job">
						   		<c:choose>
			    					<c:when test="${contract.confidentialityContractid == job.id }">
			    						<option value="${job.id }" selected="selected">${job.name }</option>
			    					</c:when>
			    					<c:otherwise>
			    						<option value="${job.id }">${job.name}</option>
