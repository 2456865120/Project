  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${pageContext.request.contextPath}/document/search">
     ...
     <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  href='${pageContext.request.contextPath}/document/toedit?id=${dept.id}'>
