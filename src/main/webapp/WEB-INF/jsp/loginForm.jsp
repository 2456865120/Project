...
<div style="width: 1360px;height:48px; background-color:RGB(43,48,59) ">
      <ul style="margin-left: 40px;padding-top:6px">
        <li style="display: inline-block;"><h1><a href="${pageContext.request.contextPath }/tologin" style="color:white;font-size:20px;">人力资源管理平台</a></h1></li>
        ...
        <li style="display: inline-block; margin-left: 64px;"><p  style="font-size:14px;color:rgb(130,130,130);">客服电话：1390341470</p></li>
      </ul>    
    </div> 
		 ...
		 <div id="register"  class="register" style="height:370px;margin-top:150px;margin-left:205px;opacity:0.9;">
            ...
            <form  method="post" action="${pageContext.request.contextPath}/login" name="check-form" id="toLoginForm"> 
                ...
                <div class="default" style="margin-top:40px;">
                    <input 	data-form="uname" type="text" placeholder="请输入登录名"  onchange="tocheckLoginname()"  id="loginname" name="loginname" value="bupanpan"/>
                </div>
                ...
                <div class="default">
                    <input id="password" name="password"
									value="bpp123" data-form="upwd" type="password" placeholder="请输入账号密码 " />
                </div>
              ...
              <div class="default" >
                    ...
                    <div class="vcode" id="vcodeDiv" style="float: right;">
			          		<img id="verifyCodeImage" title="验证码看不*清？点击获取新验证码" src="" onclick="getValidateCode()"
                ...
                <div class="submit" style="margin-top: 12px;"> 
                        ...
                        <a  href="javascript:;" onclick="location.href='${pageContext.request.contextPath}/register/registCode';" style="">没有账号？立即注册</a>
                       
                        <span class="notice">
                        
                          <a href="javascript:;" onclick="location.href='${pageContext.request.contextPath}/password/repassword';">忘记密码</a>
                        </span>
